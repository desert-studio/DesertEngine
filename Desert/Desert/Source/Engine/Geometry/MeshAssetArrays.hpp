...
namespace Desert::Geometry
{
    ...
    // Render arrays -> asset data. Submesh k takes slotMaterials[k] (Null past the end) and, when unnamed,
    ...
    MeshAssetDataFromRender( const RenderMeshData& render, std::span<const Common::UUID> slotMaterials,
