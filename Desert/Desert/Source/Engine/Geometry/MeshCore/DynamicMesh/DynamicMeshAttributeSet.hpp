...
// adapted: UE Core as std/glm, namespace Desert::Geometry; TIndirectArray is std::vector<std::unique_ptr>,
...
#include "Engine/Geometry/MeshCore/DynamicMesh/DynamicMeshTriangleAttribute.hpp"
