...
// InvertTriangleNormals), adapted: only the subset OffsetMeshRegion / InsetMeshRegion call; UE Core as
// std/glm; TPair -> std::pair; FMeshIndexMappings -> plain maps inside DuplicateTriangles (CopyAttributes
