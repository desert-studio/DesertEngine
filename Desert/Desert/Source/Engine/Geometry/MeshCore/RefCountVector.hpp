...
// Core types as std/glm, namespace Desert::Geometry, FString UsageStats and FArchive serialization (532-602)
...
namespace Desert::Geometry
{
    ...
    public:
        ...
        int Allocate()
        {
            ...
            int iFree = IndexConstants::InvalidID;
            while ( iFree == IndexConstants::InvalidID && !m_FreeIndices.IsEmpty() )
            {
