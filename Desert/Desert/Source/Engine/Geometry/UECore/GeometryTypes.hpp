// Ported from UE 5.8 Engine/Source/Runtime/GeometryCore/Public/GeometryTypes.h:1-207, adapted: UE Core via
...
namespace Desert::Geometry
{
    ...
    enum class ValidityCheckFailMode
    {
        ...
        ReturnOnly = 0,
        /** Function UE_CHECK()'s if a failure is encountered */
        Check = 1,
        /** Function UE_ENSURE()'s if a failure is encountered */
        Ensure = 2
    };
