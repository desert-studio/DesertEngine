...
namespace Desert::Localization
{
    ...
    public:
        ...
        [[nodiscard]] const LocaleRow& Language() const
        {
            return *m_Language;
        }
        ...
        [[nodiscard]] const LocalizedEntry* Find( std::string_view key ) const;
        ...
        [[nodiscard]] const std::vector<std::string>& Misses() const
        {
            return m_MissOrder;
        }
