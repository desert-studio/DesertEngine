...
namespace
{
    ...
    const std::vector<WidgetRow> kRegister = {
        ...
        // Select Elements
        { "Button", "modeLabel", Reach::Palette, { "\"Mesh selection mode: \"" } },
        ...
        { "Button", "\"Invert\"", Reach::Palette, { "SelectionOp::Invert" } },
        ...
        { "Button", "Core::ToString( row[0] )", Reach::Palette,
          { "\"Mesh operation: \"", "Core::MeshOperation::Extrude", "Core::MeshOperation::PushPull",
            ...
            "Core::MeshOperation::InsertEdgeLoop", "Core::MeshOperation::FillHole" } },
        { "Button", "Core::ToString( row[1] )", Reach::Palette,
          { "Core::MeshOperation::Outset", "Core::MeshOperation::Bevel", "Core::MeshOperation::WeldEdges" } },
