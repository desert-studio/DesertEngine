...
namespace
{
    ...
    const std::vector<AssetKind>& Catalogue()
    {
        static const std::vector<AssetKind> kinds = {
             ...
             { AssetTypeID::Retarget, "RetargetAsset", &HandleOf<Desert::Assets::RetargetAsset>,
               &MetadataTypeOf<Desert::Assets::RetargetAsset>, &DeclaredTypeOf<Desert::Assets::RetargetAsset> },
        };
        return kinds;
    }
...
namespace
{
    ...
    bool WriteShader( const std::filesystem::path& file )
    {
...
INSTANTIATE_TEST_SUITE_P(
     ...
     testing::Values( OldPathKind{ "StringTable", Common::Content::ContentKind::StringTable, &WriteStringTable,
                      ...
                      OldPathKind{ "Shader", Common::Content::ContentKind::Shader, &WriteShader,
                                   &OpenAs<Desert::Assets::ShaderAsset> } ),
     OldPathKindName );
