...
project(test_name)
    ...
    -- the three states are a property of the TYPE, and a suite that needed Vulkan to assert them
    -- would be a suite nobody runs on the machine where the states get merged by accident.
    files { test_files }
