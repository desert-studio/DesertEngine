...
project(test_name)
    ...
    files {
        ...
        "%{wks.location}/Desert/Desert/Source/Engine/Geometry/UECore/DynamicMesh/MeshIndexUtil.cpp",
        ...
        "%{wks.location}/Desert/Desert/Source/Engine/Geometry/UECore/Selections/QuadGridPatch.cpp",
