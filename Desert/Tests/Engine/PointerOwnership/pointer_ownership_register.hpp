...
namespace Desert::Tests::PointerCensus
{
    ...
    inline const std::vector<Row>& Register()
    {
        ...
        { "Desert/Desert/Source/Engine/Geometry/UECore/DynamicMesh/Operations/GroupEdgeInserter.hpp",
          ...
          "ported UE code (P12h, GeometryCore), kept in UE's shape: an FGroupEdgeInserter argument pack built at the call site; the caller's sorted std::vector<double> of loop positions (non-owning), read during InsertEdgeLoops only" },
        { "Desert/Desert/Source/Engine/Geometry/UECore/DynamicMesh/Operations/GroupEdgeInserter.hpp",
          "FGroupEdgeInserterOptionalOutputParams", "NewEidsOut", Guard::CallScoped,
          "ported UE code (P12h, GeometryCore), kept in UE's shape: an FGroupEdgeInserter argument pack built at the call site; optional caller-owned std::unordered_set<int32_t>* out-parameter (null means not wanted), written during the insert call only" },
        { "Desert/Desert/Source/Engine/Geometry/UECore/DynamicMesh/Operations/GroupEdgeInserter.hpp",
        ...
        { "Desert/Desert/Source/Engine/Geometry/UECore/DynamicMesh/Operations/GroupEdgeInserter.hpp",
          ...
          "ported UE code (P12h, GeometryCore), kept in UE's shape: an FGroupEdgeInserter argument pack built at the call site; optional caller-owned std::unordered_set<int32_t>* out-parameter (null means not wanted), written during InsertEdgeLoops only" },
        { "Desert/Desert/Source/Engine/Geometry/UECore/DynamicMesh/Operations/GroupEdgeInserter.hpp",
