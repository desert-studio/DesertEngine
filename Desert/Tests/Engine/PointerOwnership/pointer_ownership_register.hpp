...
namespace Desert::Tests::PointerCensus
{
    ...
    inline const std::vector<Row>& Register()
    {
        ...
        { "Desert/Desert/Source/Engine/Geometry/UECore/DynamicMesh/Parameterization/DynamicMeshUVEditor.hpp",
          "FDynamicMeshUVEditor", "Mesh", Guard::HostOutlivesUs,
        ...
        { "Desert/Desert/Source/Engine/Geometry/UECore/DynamicMesh/Parameterization/DynamicMeshUVEditor.hpp",
          "FDynamicMeshUVEditor", "UVOverlay", Guard::HostOutlivesUs,
        ...
        { "Desert/Desert/Source/Engine/Geometry/UECore/DynamicSubmesh3.hpp",
          "FDynamicSubmesh3", "BaseMesh", Guard::HostOutlivesUs,
        ...
        { "Desert/Desert/Source/Engine/Geometry/UECore/Parameterization/MeshDijkstra.hpp",
          "TMeshDijkstra", "PointSet", Guard::HostOutlivesUs,
        ...
        { "Desert/Desert/Source/Engine/Geometry/UECore/Parameterization/MeshLocalParam.hpp",
          "TMeshLocalParam", "PointSet", Guard::HostOutlivesUs,
          "ported UE code (P13d, GeometryCore): the exponential map's point set, held by the caller for the parameterisation's lifetime; stack-local like TMeshDijkstra" },
        ...
        { "Desert/Desert/Source/Engine/Geometry/UECore/DynamicMesh/Operations/MergeCoincidentMeshEdges.hpp",
          ...
          "ported UE code (P12, GeometryCore), kept in UE's shape: optional, caller-owned TSet<int32_t>* naming the edge subset to merge (null means the whole mesh); the caller's set outlives the merge call that reads it" },
        ...
        { "Desert/Desert/Source/Engine/Geometry/UECore/DynamicMesh/Operations/GroupEdgeInserter.hpp",
          ...
          "ported UE code (P12h, GeometryCore), kept in UE's shape: an FGroupEdgeInserter argument pack built at the call site; optional caller-owned TSet<int32_t>* out-parameter (null means not wanted), written during the insert call only" },
        { "Desert/Desert/Source/Engine/Geometry/UECore/DynamicMesh/Operations/GroupEdgeInserter.hpp",
        ...
        { "Desert/Desert/Source/Engine/Geometry/UECore/DynamicMesh/Operations/GroupEdgeInserter.hpp",
          ...
          "ported UE code (P12h, GeometryCore), kept in UE's shape: an FGroupEdgeInserter argument pack built at the call site; optional caller-owned TSet<int32_t>* out-parameter (null means not wanted), written during InsertEdgeLoops only" },
        { "Desert/Desert/Source/Engine/Geometry/UECore/DynamicMesh/Operations/GroupEdgeInserter.hpp",
