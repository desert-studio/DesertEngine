...
namespace Desert::Tests::PointerCensus
{
    ...
    inline const std::vector<Row>& Register()
    {
        ...
        { "Desert/Common/Source/Common/Json/Carry.cpp",
          ...
          "an object inside the fresh document's yyjson tree, owned by that TextDocument (its shared yyjson_doc), which MergeCarried's caller holds by reference for the whole call; the frame lives on MergeLevel's local stack" },
        { "Desert/Common/Source/Common/Json/Carry.cpp",
        ...
        { "Desert/Common/Source/Common/Json/Carry.cpp",
          ...
          "an object of the mutable merge document, freed only with that yyjson_mut_doc (MergeCarried's local MutDoc, which outlives the MergeLevel call); the frame lives on MergeLevel's local stack" },
