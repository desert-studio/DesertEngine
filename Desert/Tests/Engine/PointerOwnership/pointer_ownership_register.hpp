...
namespace Desert::Tests::PointerCensus
{
    ...
    inline const std::vector<Row>& Register()
    {
        ...
        { "Editor/Source/EditorLayer.hpp",
          "EditorLayer", "m_WorldPartitionPanel", Guard::ReboundBeforeEveryUse,
          "the same alias into m_Panels as m_FileExplorerPanel above, nulled beside it at m_Panels.Clear(); its one caller is the command palette entry for Convert to World Partition, which null-checks it and says so rather than dereferencing" },
        { "Desert/Desert/Source/Engine/Graphic/ExternalRenderPass.hpp",
