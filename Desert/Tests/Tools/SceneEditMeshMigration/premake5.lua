...
project(test_name)
    ...
    -- The migration, plus the graph model's own JSON round trip: the blob this step moves out of the
    -- entity IS that type serialized, and asserting against a second copy of the format would assert
    -- nothing.
    files {
        test_files,
