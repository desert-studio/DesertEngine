...
project(test_name)
    ...
    -- The migration and the tile codec it bakes with (LandscapeData.cpp), so the heights read back here are
    -- the bytes the loader decodes, not a second statement of the format.
    files {
        test_files,
