...
project(test_name)
    ...
    -- The whole migration TU, so the v24 -> v25 step is reached through MigrateScene like every step; the
    -- landscape and edit-mesh sources are what that TU links against.
    files {
        test_files,
